...
@login_required
def friends(request):
    #get the admin_profile and the user profile to create the first relationship
    ...
    #to get eligible profiles, exclude the user, their existing friends and friend requests already sent    
    ...
    #to get friend requestes received by the user
    ...
    #with the admin of the website (so the admin can be friends with everyone)
    ...
    #this is to  process send requests
    ...
    #this is to process receive requests
